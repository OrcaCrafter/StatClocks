...
public abstract class SheepMixin extends Animal {
	...
	@WrapOperation(method = "shear", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/animal/sheep/Sheep;dropFromShearingLootTable(Lnet/minecraft/server/level/ServerLevel;Lnet/minecraft/resources/ResourceKey;Lnet/minecraft/world/item/ItemStack;Ljava/util/function/BiConsumer;)V"))
	void dropItemFromShearingLootTable (Sheep instance, ServerLevel level, ResourceKey<LootTable> resourceKey, ItemStack shears, BiConsumer<ServerLevel, ItemStack> dropItemFunction, Operation<Void> original) {

...
public class LootTableModifications {
	...
	public static void ModifyLootTables () {
		...
		LootTableModifier.AddModifier((tableBuilder, source) -> tableBuilder.pool(
		...
		LootTableModifier.AddModifier((tableBuilder, source) -> tableBuilder.apply(
		...
		LootTableModifier.AddModifier((tableBuilder, source) -> tableBuilder.modifyPools((builder -> builder.add(
